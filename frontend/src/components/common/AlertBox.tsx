    ...
    <>
      {text === 'bye' ? (
        ...
        >
          <div className="flex flex-col gap-20 item-center justify-center fixed -translate-x-2/4 -translate-y-2/4 left-2/4 top-2/4 z-20">
            ...
            <button
              ...
              className="button-black w-[50%] sm:w-[40%] h-12 mx-auto rounded-[5px] text-lg hover:scale-105 z-20"
            >
              홈으로
            </button>
          </div>
        ...
        <div
          ...
          className="w-screen h-screen shadow-[20px_20px_100px_rgba(0,0,0,0.02)] backdrop-blur-[75px] fixed top-0 left-0 z-10"
        >
          <div className="bg-white shadow-[7px_7px_10px_rgba(0,0,0,0.25)] rounded-[10px] fixed -translate-x-2/4 -translate-y-2/4 left-2/4 top-2/4 w-[90vw] sm:w-[50vw] z-20">
            <Image
              src={tulip}
              width={100}
              height={50}
