...
export default function AlertBox({ text }: Props) {
  return (
    <div className="bg-white shadow-[7px_7px_10px_rgba(0,0,0,0.25)] rounded-[10px] absolute w-[50vw]">
      <Image src={'/imgs/tulip.png'} width={100} height={50} alt="tulip" className='absolute top-[-35px] left-[-20px]' />
      <Image src={'/imgs/tulip.png'} width={100} height={50} alt="tulip" className='absolute top-24 right-[-30px]' />
